...
def sn_panel():
    ...
    # Image (PNG/JPG)
        ...
        try:
            ...
            # derive 1D signal with vertical max projection (common approach)
...
def main_app():
    ...
    # top-level tabs depending on role: admin only sees admin, users see Linearity and S/N
